...
/*
 * 
 * NOTICE: Tamas Blummer made minor modifications of below Google code to break its link to Google's Utils class
 *
...
/**
 * A custom form of base58 is used to encode BitCoin addresses. Note that this is not the same base58 as used by Flickr, which you may see reference to around
 * the internet.
 * <p>
 * 
