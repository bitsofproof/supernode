...
public class Difficulty {
	...
	{
		return	new BigInteger (new Long(compactTarget & 0x7fffffL).toString(), 10).
				shiftLeft((int)(8 * ((compactTarget >>> 24)- 3)));
	}
	...
	public static long getNextTarget (long periodLength, long currentTarget)
	{
        ...
        BigInteger newTarget = (getTarget (currentTarget).
				multiply(BigInteger.valueOf(periodLength))).
				divide(BigInteger.valueOf(1209600));
